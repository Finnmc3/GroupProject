...
conditional_probs <- with(adult_data, prop.table(table(class, race, sex, education, native-country), margin = 1))

#please put a space before enetering each value and also use capitals at start
new_individual <- data.frame(race = " White", sex = " Male", education = " Bachelors", native-country = "")
