...
ggplot(data = adult_data, aes(x = age, y = hours_per_week, colour = class)) + geom_point()
  labs(
...
Notice that it looks like most of the blue dots (upper-class) seem to lie above the linear regression
---
...
```
---
to do: conclude that older people tend work more hours and people who work more hours tend to earn more which explains why older people are generally more likely to be upper class
---
class: center, middle
