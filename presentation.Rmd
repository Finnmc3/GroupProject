...
It looks as if better degrees tend to have a better blue to red ratio which implies a larger proportion of upper class 
```{r warning=FALSE, out.width="40", fig.width=5, echo=FALSE}
...
```{r, echo = FALSE}
adult_data %>% ggplot() + geom_bar(mapping = aes(x = has_degree, fill = class), position = "dodge")
```
---
##Our final vizualsation is the relationship between race and class
